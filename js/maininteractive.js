...
;(function(window) {
	...
	PointsMap.prototype._initEvents = function() {
        ...
        close.click(function(){
            ...
            $('.image-overlay').removeClass('image-opacity');
               $('.image-overlay img').removeClass('image-opacity');
        $('.image-overlay img').removeClass('image-op');
        });
    ...
    $('.image-overlay').click(function(){
        $('.image-overlay img').each(function(index){
           if($(this).hasClass('image-op')==true){
              $(this).addClass('image-opacity'); 
           }
            ...
            else console.log('sdd');
        });
        console.log('sdsd');
    });
    var overlay=function(pos){
        $('.image-overlay').addClass('image-opacity');
        
        
        
        
         if(pos==0){
            $('.counterimg').addClass('image-op');
        }
        if(pos==1)
        {
             $('.hydimg').addClass('image-op');
        }
      if(pos==2){
             $('.mailimg').addClass('image-op');
        }
    }
